...
legend("topright", lty = 1, col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), x.intersp = 0.8, xjust = 0)
with(plotData, plot(x = Time, y = Global_reactive_power, type = "l", ylab = "Global Reactive Power", xlab = "datetime"))
